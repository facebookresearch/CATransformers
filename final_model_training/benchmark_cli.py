...
### Modified based on Clip_benchmarks' cli.py file, inorder to run our pruned models. 
import argparse
import csv
import json
import os
...
def get_parser_args():
    ...
    parser_eval.add_argument('--recall_k', default=[1], type=int, help="for retrieval, select the k for Recall@K metric. ", nargs="+",)
